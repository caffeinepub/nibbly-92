...
function buildWalls(level) {
  ...
  if (level === 1) {
    for (let x = 5; x <= 10; x++) add2(x, 6);
    for (let x = 29; x <= 34; x++) add2(x, 6);
    for (let x = 5; x <= 10; x++) add2(x, 23);
    for (let x = 29; x <= 34; x++) add2(x, 23);
    for (let y = 6; y <= 11; y++) add2(5, y);
    for (let y = 6; y <= 11; y++) add2(34, y);
    for (let y = 18; y <= 23; y++) add2(5, y);
    for (let y = 18; y <= 23; y++) add2(34, y);
    for (let x = 16; x <= 23; x++) add2(x, 10);
    for (let x = 16; x <= 23; x++) add2(x, 19);
    for (let y = 10; y <= 14; y++) add2(16, y);
    for (let y = 10; y <= 14; y++) add2(23, y);
    for (let y = 15; y <= 19; y++) add2(16, y);
    for (let y = 15; y <= 19; y++) add2(23, y);
  } else if (level === 2) {
    for (let x = 4; x <= 14; x++) add2(x, 5);
    for (let x = 25; x <= 35; x++) add2(x, 5);
    for (let x = 4; x <= 14; x++) add2(x, 24);
    for (let x = 25; x <= 35; x++) add2(x, 24);
    for (let y = 5; y <= 12; y++) add2(4, y);
    for (let y = 5; y <= 12; y++) add2(14, y);
    for (let y = 5; y <= 12; y++) add2(25, y);
    for (let y = 5; y <= 12; y++) add2(35, y);
    for (let y = 17; y <= 24; y++) add2(4, y);
    for (let y = 17; y <= 24; y++) add2(14, y);
    for (let y = 17; y <= 24; y++) add2(25, y);
    for (let y = 17; y <= 24; y++) add2(35, y);
    for (let x = 17; x <= 22; x++) add2(x, 14);
    for (let x = 17; x <= 22; x++) add2(x, 15);
    for (let y = 8; y <= 11; y++) add2(19, y);
    for (let y = 8; y <= 11; y++) add2(20, y);
    for (let y = 18; y <= 21; y++) add2(19, y);
    for (let y = 18; y <= 21; y++) add2(20, y);
    for (let x = 8; x <= 11; x++) add2(x, 14);
    for (let x = 8; x <= 11; x++) add2(x, 15);
    for (let x = 28; x <= 31; x++) add2(x, 14);
    for (let x = 28; x <= 31; x++) add2(x, 15);
  } else if (level === 3) {
    for (let x = 2; x <= 18; x++) add2(x, 4);
    for (let x = 21; x <= 37; x++) add2(x, 4);
    for (let x = 2; x <= 18; x++) add2(x, 25);
    for (let x = 21; x <= 37; x++) add2(x, 25);
    for (let y = 4; y <= 25; y++) add2(2, y);
    for (let y = 4; y <= 25; y++) add2(37, y);
    for (let y = 7; y <= 14; y++) add2(6, y);
    for (let y = 7; y <= 14; y++) add2(12, y);
    for (let y = 15; y <= 22; y++) add2(6, y);
    for (let y = 15; y <= 22; y++) add2(12, y);
    for (let y = 7; y <= 14; y++) add2(27, y);
    for (let y = 7; y <= 14; y++) add2(33, y);
    for (let y = 15; y <= 22; y++) add2(27, y);
    for (let y = 15; y <= 22; y++) add2(33, y);
    for (let x = 6; x <= 12; x++) add2(x, 7);
    for (let x = 6; x <= 12; x++) add2(x, 14);
    for (let x = 6; x <= 12; x++) add2(x, 22);
    for (let x = 27; x <= 33; x++) add2(x, 7);
    for (let x = 27; x <= 33; x++) add2(x, 14);
    for (let x = 27; x <= 33; x++) add2(x, 22);
    for (let x = 15; x <= 24; x++) add2(x, 9);
    for (let x = 15; x <= 24; x++) add2(x, 20);
    for (let y = 9; y <= 20; y++) add2(15, y);
    for (let y = 9; y <= 20; y++) add2(24, y);
  } else {
    const lv = (level - 4) % 3;
    for (let x = 3; x <= 36; x++) {
      add2(x, 3);
    ...
    if (lv === 0) {
      for (let x = 7; x <= 32; x += 5) {
        for (let y = 6; y <= 23; y++) add2(x, y);
      }
      for (let y = 8; y <= 21; y += 5) {
        for (let x = 5; x <= 34; x++) add2(x, y);
      }
      for (let x = 7; x <= 32; x += 5) {
        add2(x, 12);
        walls.delete(`${x},12`);
      ...
      for (let x = 7; x <= 32; x++) add2(x, 7);
      for (let y = 7; y <= 22; y++) add2(32, y);
      for (let x = 7; x <= 32; x++) add2(x, 22);
      for (let y = 7; y <= 18; y++) add2(7, y);
      for (let x = 11; x <= 28; x++) add2(x, 11);
      for (let y = 11; y <= 22; y++) add2(28, y);
      for (let x = 11; x <= 28; x++) add2(x, 18);
      for (let y = 11; y <= 18; y++) add2(11, y);
      walls.delete("19,7");
      walls.delete("20,7");
      walls.delete("32,14");
      walls.delete("32,15");
...
class AudioEngine {
  constructor() {
    ...
    __publicField(this, "musicIntervalId", null);
  ...
  playNote(freq, type, startTime, duration, gain = 0.3) {
    ...
    g.gain.exponentialRampToValueAtTime(1e-3, startTime + duration);
    osc.connect(g);
...
function drawWalls(ctx, wallArr) {
...
function drawSnake(ctx, snake) {
  ...
  for (let i = 0; i < len; i++) {
    ...
    const glowColor = i === 0 ? "#00FFFF" : i < len * 0.5 ? "#0088FF" : "#FF00FF";
    const px = seg.x * CELL;
    const py = seg.y * CELL;
...
function drawFoods(ctx, foods, tick) {
...
function drawHUD(ctx, score, level, remaining, total) {
...
function drawStartScreen(ctx, tick) {
...
function drawLevelUpScreen(ctx, level, tick) {
...
function drawGameOverScreen(ctx, score, level, tick) {
...
function DPadButton({ label, ocid, onPress, style: style2 }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "button",
    {
      ...
      onPointerEnter: (e) => {
        e.currentTarget.style.background = "rgba(57,230,255,0.18)";
      },
      onPointerLeave: (e) => {
...
function App() {
  ...
  const stateRef = reactExports.useRef("START");
  const snakeRef = reactExports.useRef([]);
  const dirRef = reactExports.useRef({ x: 1, y: 0 });
  const nextDirRef = reactExports.useRef({ x: 1, y: 0 });
  const foodsRef = reactExports.useRef([]);
  const totalFoodsRef = reactExports.useRef(0);
  const scoreRef = reactExports.useRef(0);
  const speedRef = reactExports.useRef(START_SPEED);
  const tickRef = reactExports.useRef(0);
  const levelRef = reactExports.useRef(1);
  const rafRef = reactExports.useRef(0);
  const timeoutRef = reactExports.useRef(null);
  const wallsRef = reactExports.useRef(buildWalls(1));
  const wallArrRef = reactExports.useRef([]);
  const demoSnakeRef = reactExports.useRef([]);
  const demoDirRef = reactExports.useRef({ x: 1, y: 0 });
  const demoTickRef = reactExports.useRef(0);
  const touchStartRef = reactExports.useRef(null);
  const levelUpTickRef = reactExports.useRef(0);
  const getCtx = reactExports.useCallback(
    () => {
      var _a2;
      return ((_a2 = canvasRef.current) == null ? void 0 : _a2.getContext("2d")) ?? null;
    },
    []
  );
  const rebuildWalls = reactExports.useCallback((level) => {
  ...
  const spawnAllFoods = reactExports.useCallback(() => {
  ...
  const initLevel = reactExports.useCallback(
    (level, keepSnake) => {
      rebuildWalls(level);
      if (!keepSnake) {
        snakeRef.current = [
        ...
        outer: for (let x = 5; x < COLS - 5; x++) {
          for (let y = 5; y < ROWS - 5; y++) {
            if (!wallsRef.current.has(`${x},${y}`) && !wallsRef.current.has(`${x - 1},${y}`) && !wallsRef.current.has(`${x - 2},${y}`)) {
              snakeRef.current = [
                { x, y },
                { x: x - 1, y },
                { x: x - 2, y }
  ...
  const gameTick = reactExports.useCallback(() => {
    ...
    if (walls.has(`${newHead.x},${newHead.y}`)) {
      const perpLeft = { x: dir.y, y: -dir.x };
      const perpRight = { x: -dir.y, y: dir.x };
      if (!walls.has(`${head.x + perpLeft.x},${head.y + perpLeft.y}`)) {
        dir = perpLeft;
        nextDirRef.current = dir;
        dirRef.current = dir;
        newHead = { x: head.x + dir.x, y: head.y + dir.y };
      } else if (!walls.has(`${head.x + perpRight.x},${head.y + perpRight.y}`)) {
        dir = perpRight;
        nextDirRef.current = dir;
        dirRef.current = dir;
        newHead = { x: head.x + dir.x, y: head.y + dir.y };
  ...
  const startGameLoop = reactExports.useCallback(() => {
    if (timeoutRef.current) clearTimeout(timeoutRef.current);
    timeoutRef.current = setTimeout(gameTick, speedRef.current);
  }, [gameTick]);
  const handleDirection = reactExports.useCallback(
    (dir) => {
  ...
  reactExports.useEffect(() => {
    ...
    const handleKey = (e) => {
      ...
      if ((key === "ArrowUp" || key === "w" || key === "W") && cur.y !== 1)
        nextDirRef.current = { x: 0, y: -1 };
      else if ((key === "ArrowDown" || key === "s" || key === "S") && cur.y !== -1)
        nextDirRef.current = { x: 0, y: 1 };
      else if ((key === "ArrowLeft" || key === "a" || key === "A") && cur.x !== 1)
        nextDirRef.current = { x: -1, y: 0 };
      else if ((key === "ArrowRight" || key === "d" || key === "D") && cur.x !== -1)
        nextDirRef.current = { x: 1, y: 0 };
    ...
    (_a2 = canvasRef.current) == null ? void 0 : _a2.focus();
    return () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      style: {
        ...
        alignItems: "center",
        justifyContent: "center",
        background: "linear-gradient(135deg, #070812 0%, #0B0C18 50%, #07080F 100%)",
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "canvas",
          {
            ...
            style: {
              ...
              cursor: "none",
              outline: "none",
              boxShadow: "0 0 10px #39E6FF, 0 0 30px #39E6FF, 0 0 60px #8B4DFF, 0 0 2px #FF43C6 inset",
              border: "2px solid #39E6FF",
              maxWidth: "100vw",
              touchAction: "none"
            }
        ...
        isTouchDevice && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
