...
function buildWalls() {
  ...
  for (let x = 5; x <= 12; x++) add2(x, 5);
  for (let x = 5; x <= 12; x++) add2(x, 24);
  for (let x = 27; x <= 34; x++) add2(x, 5);
  for (let x = 27; x <= 34; x++) add2(x, 24);
  for (let x = 15; x <= 24; x++) add2(x, 8);
  for (let x = 15; x <= 24; x++) add2(x, 21);
  for (let x = 8; x <= 14; x++) add2(x, 14);
  for (let x = 25; x <= 31; x++) add2(x, 14);
  for (let y = 5; y <= 10; y++) add2(5, y);
  for (let y = 5; y <= 10; y++) add2(34, y);
  for (let y = 19; y <= 24; y++) add2(5, y);
  for (let y = 19; y <= 24; y++) add2(34, y);
  for (let y = 8; y <= 13; y++) add2(15, y);
  for (let y = 8; y <= 13; y++) add2(24, y);
  for (let y = 16; y <= 21; y++) add2(15, y);
  for (let y = 16; y <= 21; y++) add2(24, y);
  for (let y = 11; y <= 13; y++) add2(10, y);
  for (let y = 11; y <= 13; y++) add2(29, y);
  for (let y = 16; y <= 18; y++) add2(10, y);
  for (let y = 16; y <= 18; y++) add2(29, y);
  for (let x = 18; x <= 21; x++) add2(x, 3);
  for (let x = 18; x <= 21; x++) add2(x, 26);
  for (let y = 11; y <= 18; y++) add2(2, y);
  for (let y = 11; y <= 18; y++) add2(37, y);
  return walls;
}
const WALLS = buildWalls();
const WALL_ARR = Array.from(WALLS).map((s) => {
...
function drawFood(ctx, food, tick) {
...
function drawGameOverScreen(ctx, score, tick) {
...
function App() {
  ...
  const foodRef = reactExports.useRef({ x: 20, y: 15 });
  ...
  const spawnFood = reactExports.useCallback(() => {
